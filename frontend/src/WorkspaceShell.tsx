  ...
  return <div className="app railway-site">
    ...
    <div className="workspace-body">
      ...
      <div className="main-column">
        {['/planner','/queue','/tasks','/opportunities','/disruptions','/availability','/insights'].includes(location.pathname)&&<section className="workflow-context" aria-label="Workflow purpose"><strong>{['/availability','/insights'].includes(location.pathname)?'Predictive decision support':'Maintenance block planning'}</strong><NavLink to={destination('/help/methods')}>How the models work</NavLink></section>}
        {children}
