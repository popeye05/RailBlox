...
Typography refinement: Figtree remains the base face, with 800-weight page titles, 750-weight metrics, 700-weight panel headings and 350-weight introductory text. Navigation and corridor surfaces use RailBLOX black; red accents and meaningful status colors remain. Repeated shell timezone labels and the proposal ID badge were removed. Saved-plan selection and source metadata are now collapsed disclosures, preserving history review and provenance without permanent header clutter. Timezone calculations, operational table/chart labels and exported data are unchanged.
